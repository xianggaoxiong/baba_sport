...
<div class="box-positon">
	...
	<form class="ropt">
		<input class="add" type="button" value="添加" onclick="javascript:window.location.href='/back/product/toAdd.do'"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
...
<table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
	...
	<c:forEach items="${pagination.list }" var="product">
		<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
			...
			<td align="center">
			<a href="#" class="pn-opt">查看</a> | <a href="#" class="pn-opt">修改</a> | <a href="#" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a> | <a href="/back/sku/list.do?productId=${product.id }&productNo=${product.no}" class="pn-opt">库存</a>
			</td>
		</tr>
	</c:forEach>	
	</tbody>
...
<div class="page pb15"><span class="r inb_a page_b">
	<c:forEach items="${pagination.pageView }" var="pages">
	${pages }
	</c:forEach>
</span></div>
